...
version = '0.0.3' # WARNING: modified by setver.bash
...
latex_documents = [
    (master_doc, 'TaskThread.tex', 'TaskThread Documentation',
...
man_pages = [
  (master_doc, 'TaskThread', 'TaskThread Documentation',[author], 1)
]
